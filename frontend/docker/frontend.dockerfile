...
COPY frontend/docker/files/frontend-htaccess /usr/local/apache2/htdocs/.htaccess
COPY frontend/docker/files/frontend-httpd.conf /usr/local/apache2/conf/httpd.conf
